...
whichint=ToExpression[$ScriptCommandLine[[2]]];

(****************************************************************************************)


Print["\n This is a proof-of-concept demostration to evaluate the "<>ToString[whichint]<>"-th UT integrals via one-fold integration with auxiliary B-matrix at: \n \n "]
...
Print["Evaluating The "<>ToString[whichint]<>"-th UT integral. "];
w0123={BC0[[whichint]],W1[[whichint]],W2[[whichint]],W3[[whichint]]}/.basisdef/.LetterRep/.RootDef/.{s12->-(79/46),s23->-(129/29),s34->-(89/36),s45->-(87/55),s15->-(51/13)};
...
Export["UT-Int-"<>ToString[whichint]<>".m",Join[N[w0123,32],{w4num,w5num,w6num}]];
